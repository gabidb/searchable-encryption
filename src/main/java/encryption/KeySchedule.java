...
public class KeySchedule {
    ...
    /*
        AES requires a separate 128-bit round key block for each round (11 in total).
        keyExpansion generates 11 round keys derived from the key generated by generateKey()
     */
    public byte[][] keyExpansion(int rounds, byte[] key) {
     ...
     */
    private byte[] getWord(byte[] key, int index)
    {
        byte[] tmp = new byte[4];
    ...
    /*
        Set the key
     */
    private void setWord(byte[] key, byte[] word, int index)
    {
